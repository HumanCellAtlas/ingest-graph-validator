...
for submission in load_list:
    subid2neo(submission, threads=5)


# Demo connection error to ingest API
# subid2neo('5bdc209b9460a300074b7e67', threads=100) # less threads just gives a slower crash
