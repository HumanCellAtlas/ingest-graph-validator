...
def make_links(processes, totalElements):
	...
	processes_chunked = list(split(processes_list, 50))
	thread_pool = Pool(50)
...
if __name__ == '__main__':
	...
	node_types = {}
	node_types['protocols'] = ingest_api.getEntities(subs_url, "protocols")
	node_types['biomaterials'] = ingest_api.getEntities(subs_url, "biomaterials")
	node_types['files'] = ingest_api.getEntities(subs_url, "files")
	node_types['processes'] = ingest_api.getEntities(subs_url, "processes")
